  ...
  return (
    <Html>
      <Head>
        ...
        />
        <meta property="og:url" content="https://transportation-spa-project.vercel.app" />
        <meta property="og:site_name" content="Framer Motion Project" />
        <meta property="og:image" content="https://transportation-spa-project.vercel.app/screenshot.jpg" />
        <meta name="keywords" content="nextjs,framer motion,animation" />

        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Framer Motion Project" />
        <meta name="twitter:description" content="Nextjs Project using framer montion" />
        <meta name="twitter:image" content="https://transportation-spa-project.vercel.app/screenshot.jpg" />

        <link rel="canonical" href="https://transportation-spa-project.vercel.app" />
        <link rel="alternate" href="https://transportation-spa-project.vercel.app" hreflang="en-us" />
      </Head>
      <body>
        <Main />
        <NextScript />
